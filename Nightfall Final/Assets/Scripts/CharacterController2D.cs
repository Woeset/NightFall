...
namespace Prime31 {
    ...
    public class CharacterController2D : MonoBehaviour {
        ...
        void primeRaycastOrigins() {
            ...
            DrawRay(_raycastOrigins.topLeft, Vector3.right, Color.blue);
            DrawRay(_raycastOrigins.topLeft, Vector3.up, Color.blue);
            DrawRay(_raycastOrigins.topLeft, Vector3.left, Color.blue);
            DrawRay(_raycastOrigins.topLeft, Vector3.down, Color.blue);
        }
